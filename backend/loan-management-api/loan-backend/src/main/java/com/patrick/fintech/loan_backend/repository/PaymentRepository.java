...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    /**
     * Returns payments actually collected during a reporting period.
     *
     * organizationId:
     *     Restricts payments to one institution.
     *
     * branchId:
     *     Optional branch filter.
     *
     * from / to:
     *     Inclusive reporting dates.
     *
     * Only payments with paid = true are returned because regulatory
     * collection statistics should not treat scheduled/unpaid
     * installments as money collected.
     */
    @Query("""
        SELECT p
        FROM Payment p
