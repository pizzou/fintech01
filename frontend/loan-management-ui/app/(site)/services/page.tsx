    ...
    <div>
      ...
      <section className="py-20 text-white text-center"
        ...
        <div className="max-w-3xl mx-auto px-4">
          <h1 className="font-display text-4xl md:text-5xl font-extrabold mb-4">Our Financial Services</h1>
          ...
          {tenant.services?.map((service, idx) => (
            <div key={service.title}
              ...
              <div className={idx % 2 === 1 ? 'md:order-2' : ''}>
                ...
                <h2 className="font-display text-2xl md:text-3xl font-extrabold text-gray-900 mb-3">{service.title}</h2>
              ...
              {/* Requirements */}
              <div className={`bg-gray-50 rounded-2xl p-8 border border-gray-100 ${idx % 2 === 1 ? 'md:order-1' : ''}`}>
      ...
      <section className="py-16 text-center" style={{ backgroundColor: primary + '08' }}>
        <div className="max-w-2xl mx-auto px-4">
          <h2 className="font-display text-3xl font-extrabold text-gray-900 mb-4">Not sure which loan is right for you?</h2>
